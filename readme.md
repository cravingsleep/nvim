...
Navigating buffers is provided by [telescope](https://github.com/nvim-telescope/telescope.nvim). It uses
[frecency](https://github.com/nvim-telescope/telescope-frecency.nvim) to order the buffers.
...
The status line displays the mode, git branch, filename, alternate buffer, lsp status, cursor position and the time.
